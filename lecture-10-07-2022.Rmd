...
$$
  \hat\tau_j = N_1\bar{y}_1 + N_2\bar{y}_2 + \cdots + N_L\bar{y}_L,
$$
...
Different approaches arise due to (a) the choice of auxiliary variable(s), and (b) what we mean by "close."
