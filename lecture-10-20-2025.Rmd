...
0. Use a sampling design (e.g., SRS, PPS) to select some clusters from each stratum. 
...
<!-- We can talk about different sampling designs for clusters: SRS, PPS, stratified, and cluster (which then becomes multi-stage cluster sampling). -->
