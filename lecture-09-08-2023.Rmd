...
Observe that $n_j$ is *proportional to* $N_j\sigma_j/\sqrt{c_j}$. What does this tell us about the relationship between $n_j$ and $N_j$, $n_j$ and $\sigma_j$, and $n_j$ and $c_j$? To which strata do we allocate large sample sizes? 
...
0. An optimum allocation may produce $n_j = 0$ or $n_j = 1$. But to estimate $s_j^2$ we need all $n_j \ge 2$.
