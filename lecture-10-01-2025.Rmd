...
p <- p + annotate("text", x = 0.47, y = 5.2, label = tex("$\\bar{y} / \\mu_x$", output = "character"), parse = TRUE, hjust = 0)
p <- p + annotate("text", x = 0.47, y = 4.7, label = tex("$\\bar{y} / \\bar{x}$", output = "character"), parse = TRUE, hjust = 0)
...
$$
Multiplying this estimator by $N$ would give us an estimator of $\tau_y$ since $\tau_y = N\mu_y$, so that would be
$$
