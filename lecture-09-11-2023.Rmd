...
<!-- This lecture could use a little life. Not sure how to do that though. Possibly discuss other kinds of optimum allocation (e.g., specific domains)? Also maybe show how to compute the design effect by estimating \sigma for the SRS variance from the sample from a stratified design? -->
...
p <- p + theme(legend.position = c(0.2, 0.8)) + noyaxis
