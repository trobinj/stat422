...
$$
  \hat{V}(r) = \frac{1}{\mu_x^2}\left(1 - \frac{n}{N}\right)\frac{s_r^2}{n} \ \ \ \text{where} \ \ \ s_r^2 = \frac{\sum_{i \in \mathcal{S}} (y_i - rx_i)^2}{n-1}.
$$
...
**Example**: Consider a survey to estimate the proportion of households with televisions in Des Moines, Iowa, in 1951. The sampling units are *blocks* of households. Here $y_i$ is the number of households with televisions in the $i$-th block, and $x_i$ is the number of households in the $i$-th block. 
```{r}
