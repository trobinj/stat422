...
```
What is $\hat\mu_1$ and the estimate of the variance of that estimator? What is $\hat\tau_1$ and the estimate of the variance of that estimator?
...
ktbl(d, align = c("c","c","c","c"))
```
What is the estimate of $\mu_{2,3}$ and the estimated variance of that estimator?
...
ktbl(d)
```
What is the estimate of $\mu_1 - \mu_3$ and what is the estimated variance of the estimator $\hat\mu_1 - \hat\mu_3$?
